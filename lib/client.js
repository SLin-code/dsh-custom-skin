...
var en = {
  ...
  languageHint: "Switches the language across DSH Web.",
  ...
  use: "Use",
  remove: "Remove",
  removeConfirm: "Delete this wallpaper from local storage?",
  ...
  clearConfirm: "Delete every saved wallpaper from this browser?",
...
var zh = {
  ...
  language: "\u754C\u9762\u8BED\u8A00",
  languageHint: "\u5207\u6362\u6574\u4E2A DSH Web \u7684\u754C\u9762\u8BED\u8A00\u3002",
  upload: "\u6DFB\u52A0\u58C1\u7EB8",
  ...
  reset: "\u6062\u590D\u9ED8\u8BA4\u5916\u89C2",
  clear: "\u5220\u9664\u5168\u90E8\u58C1\u7EB8",
  clearConfirm: "\u786E\u5B9A\u5220\u9664\u5F53\u524D\u6D4F\u89C8\u5668\u4E2D\u4FDD\u5B58\u7684\u5168\u90E8\u58C1\u7EB8\u5417\uFF1F",
  loading: "\u6B63\u5728\u8BFB\u53D6\u672C\u5730\u58C1\u7EB8\u2026",
...
function SkinSection({ t, useSkin, controller, locale }) {
  const state = useSkin((snapshot) => snapshot);
  const localeState = (0, import_react.useSyncExternalStore)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-skin-section", "aria-busy": !state.ready, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "dsh-skin-language", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh-skin-toggle-copy", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t("language") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { className: "dsh-skin-hint", children: t("languageHint") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "select",
        {
          ...
          children: localeState.locales.map((option) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: option.id, children: option.label }, option.id))
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "label",
      {
        ...
        "data-disabled": !state.ready || void 0,
        onDragEnter: () => {
          setDragging(true);
        },
        onDragLeave: () => {
    ...
    state.error !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "dsh-skin-error", role: "alert", children: t(state.error === "storage" ? "storageError" : state.error === "invalid-file" ? "invalidFile" : state.error === "mutation" ? "mutationError" : "uploadError") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-skin-actions", children: [
      ...
      state.wallpapers.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "dsh-skin-button dsh-skin-button-danger", type: "button", onClick: clear, children: t("clear") })
    ] })
  ] });
}
...
@media (max-width: 700px) {
  .dsh-skin-language { align-items: stretch; flex-direction: column; gap: 10px; }
  .dsh-skin-language select { width: 100%; }
